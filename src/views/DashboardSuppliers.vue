<template>
  <menuHorizontal />
  <menuVertical />
  <div class="fundoDashboardSup">
      <div class="conteudoDashboardSup">
        ...
        <oracle-dv project-path="/@Catalog/users/ana.leal01@fatec.sp.gov.br/Oracle-Dinner-original" active-page="insight" active-tab-id="2">
        </oracle-dv>
      </div>
  </div>
</template>
